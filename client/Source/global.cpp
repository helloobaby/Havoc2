  ...
  if (FileDialog.exec() == QFileDialog::Accepted) {
    ...
    if (!Filename.toString().isNull()) {
      ...
      if (file.open(QIODevice::ReadWrite)) {
        ...
        SessionData.insert("MagicValue",
                           QJsonValue::fromVariant((int)MagicValue));
        ...
        SessionData.insert("ProcessElevated",
                           QJsonValue::fromVariant(Elevated));
        ...
        spdlog::error("Couldn't write to file {}",
